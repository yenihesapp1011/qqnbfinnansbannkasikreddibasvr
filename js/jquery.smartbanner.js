...
!function ($) {
    var SmartBanner = function (options) {
        ...
        return // Bu yapı kaldırıldıgı ıcın eklendi.
        // Calculate scale
        ...
        var meta = $(this.type == 'android' ? 'meta[name="google-play-app"]' :
            this.type == 'ios' ? 'meta[name="apple-itunes-app-new"]' : 'meta[name="msApplication-ID"]');
    ...
    SmartBanner.prototype = {
      ...
      , listen: function () {
          $('#smartbanner .sb-close').bind('click', $.proxy(this.close2, this))
          $('#smartbanner .sb-button').bind('click', $.proxy(this.install, this))
      }

      , show: function (callback) {
          $('#smartbanner').stop().animate({ top: 0 }, this.options.speedIn).addClass('shown')
          $('#login_main').animate({ marginTop: this.origHtmlMargin + (this.bannerHeight * this.scale) }, this.options.speedIn, 'swing', callback)
      }

      , hide: function (callback) {
          $('#login_main').animate({ 'margin-top': "0px" }, 400);
...
, close2: function (e) {
    ...
    this.setCookie('sb-closed', 'true', this.options.daysHidden)
      ...
      , switchType: function () {
          ...
          this.hide(function () {
              ...
              var meta = $(that.type == 'android' ? 'meta[name="google-play-app"]' : 'meta[name="apple-itunes-app-new"]').attr('content')
    ...
    $.smartbanner.defaults = {
        ...
        inWindowsStore: 'Windows Store\'da', //Text of price for Windows
        icon: 'http://a1.mzstatic.com/us/r30/Purple62/v4/f8/cc/7c/f8cc7c28-085f-8c15-3b41-1887202693d3/icon175x175.jpeg', // The URL of the icon (defaults to <meta name="apple-touch-icon">)
